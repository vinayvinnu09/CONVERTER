...
class Main(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Create amount label
        self.amount_label = Label(self, text='Input Amount: ', bg='#54abb0', fg='white', font=('franklin gothic book', 15))
        ...
        # Create 'from' label
        self.base_currency_label = Label(self, text='From: ', bg='#d94a62', fg='white', font=('franklin gothic book', 15))
        self.base_currency_label.place(x=200, y=140, anchor='center')

        # Create 'to' label
        self.destination_currency_label = Label(self, text='To: ', bg='#d94a62', fg='white', font=('franklin gothic book', 15))
